...
import Vetri from "./images/vetri.jpeg";
import {
  VerticalTimeline,
      ...
      <div className="flex w-screen min-h-screen flex-col items-center justify-center relative bg-primary pb-20">
        <nav className="w-full px-6 z-50  fixed inset-x-0 top-2 flex justify-center items-center ">
          <div className=" w-full md:w-880 bg-navBar p-4 rounded-2xl flex items-center">
            <p className="text-lg text-slate-200 font-medium">Tanshul</p>
          ...
          >
            ...
            <div className="w-full h-420 flex flex-col items-center justify-center ">
              <p className="text-lg text-textBase text-center">
                Hii, I am Tanshul and this is my web portfolio. This will show you guys the projects I worked on and
                the technologies in which I have experience.Hope you will find it interesting.
              </p>
